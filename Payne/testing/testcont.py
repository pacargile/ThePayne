...
from ..predict import predictspec,predictcont
...
class TestCont(object):
    ...
    def runtest(self,**kwargs):
        ...
        with PdfPages(output) as pdf:
            ...
            histxrange = [histxrange[0]-0.5,histxrange[1]+0.5]
            # histxrange = [-4.5,-1]
            # histxrange = [-4.5,3.0]
            ...
            ax[0,0].set_ylim(histxrange)
            ax[1,0].set_ylim(histxrange)
            ax[0,1].set_ylim(histxrange)
            ax[1,1].set_ylim(histxrange)
